...
void TransformSystem::InitializeSystem(EntityManager *eManager, ComponentManager *cManager, EventManager *evManager, PrototypeManager *pManager)
{
	m_cManager = cManager;
}
...
{
	if (component->transformInstant == instant)
		return;
...
{
	for (TransformComponent *transformComp : m_cManager->GetComponents<TransformComponent>())
	{
