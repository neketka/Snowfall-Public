...
void CameraSystem::InitializeSystem(EntityManager *eManager, ComponentManager *cManager, EventManager *evManager, PrototypeManager *pManager)
{
	m_eManager = eManager;
	m_cManager = cManager;
}
...
{
	for (CameraComponent *camera : m_cManager->GetComponents<CameraComponent>())
	{
