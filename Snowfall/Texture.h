...
public:
	Texture() {}
	Texture(int width, int levels, TextureInternalFormat format);
	...
	void GenerateMipmap();
	void SetData(int x, int w, int level, TexturePixelFormat format, TextureDataType type, const void *pixels);
