...
public:
	...
	Framebuffer(WrappedTextureView depth, bool hasStencil);
	Framebuffer(std::vector<WrappedTextureView> colorAttachments, WrappedTextureView depth, bool hasStencil);
